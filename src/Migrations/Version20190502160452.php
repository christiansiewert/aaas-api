 ...
 */
final class Version20190502160452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE App_Field_Relation (id INT AUTO_INCREMENT NOT NULL, join_column_id INT DEFAULT NULL, type VARCHAR(2) DEFAULT \'1n\' NOT NULL, target_entity VARCHAR(255) NOT NULL, mapped_by VARCHAR(255) DEFAULT NULL, inversed_by VARCHAR(255) DEFAULT NULL, orphan_removal TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_21FF0C41138F07 (join_column_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE App_Relation_Joincolumn (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, referenced_column_name VARCHAR(255) DEFAULT \'id\' NOT NULL, is_unique TINYINT(1) DEFAULT \'0\' NOT NULL, is_nullable TINYINT(1) DEFAULT \'1\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
