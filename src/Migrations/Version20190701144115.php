 ...
 */
final class Version20190701144115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE App_Field_Option (id INT AUTO_INCREMENT NOT NULL, service_field_id INT NOT NULL, default_value VARCHAR(255) NOT NULL, is_unsigned TINYINT(1) NOT NULL, comment VARCHAR(255) NOT NULL, INDEX IDX_BAEE3380BD415C8D (service_field_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
