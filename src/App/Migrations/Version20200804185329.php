 ...
 */
final class Version20200804185329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE App_Filter_Property (id INT AUTO_INCREMENT NOT NULL, filter_id INT NOT NULL, field_id INT NOT NULL, value VARCHAR(255) NOT NULL, INDEX IDX_BB70162BD395B25E (filter_id), UNIQUE INDEX UNIQ_BB70162B443707B0 (field_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
